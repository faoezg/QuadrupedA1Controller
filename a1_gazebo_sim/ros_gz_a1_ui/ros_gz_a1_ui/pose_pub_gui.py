...
class PosePubGUI(Node):
    def __init__(self, width=400, height=300):
        super().__init__('pose_pub_gui')
        ...
        # ROS2 setup
        self.pose_publisher = self.create_publisher(Pose, '/goal_pose', 10)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if self.active_joystick1:
                    ...
                    self.slider_width = self.base_width - ((self.joystick3_pos[1] - self.CENTER3[1]) / (self.SLIDER_RADIUS - self.JOYSTICK_RADIUS))/20
        return True
